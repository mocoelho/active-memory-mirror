...
<html>
  <head>
    ...
    <title>cpanm AI::MicroStructure</title>

    <link id="prettify-link" href="./lib/css/prettify.css" rel="stylesheet" disabled />
    <link href="./lib/css/moon.css" class="theme" rel="stylesheet"  media="screen" />
    <link href="./lib/css/sand.css" class="theme" rel="stylesheet" />
    <link href="./lib/css/sea_wave.css" class="theme" rel="stylesheet" />
    <link href="./lib/css/default.css" class="theme" rel="stylesheet"  />
    <link href="./lib/css/common.css" rel="stylesheet" media="screen" />
  ...
  <body>
    ...
    <script src="./lib/js/Keys.js"></script>
...
<header>&nbsp;&nbsp;&nbsp;&rarr;&nbsp;&nbsp;&nbsp;<b>Active Memory Mirror</b></header>
<br>
...
<!---//
   <div class="slide" id="stream-slide">
               <section class="middle">
   <iframe src="./lib/plug/audio-podcast/index.html" width="85%" height="90%"></iframe>
          </section>
            <aside class="note">
            <section>
  ...
  <div class="slide" id="playlist-slide">
               <section class="middle">
      <iframe src="./lib/plug/player/playlist.html" width="94%" height="90%"></iframe>
  ...
  <div class="slide" id="micro-search-slide">
               <section class="middle">
  <iframe src="./lib/plug/local/index.html" width="94%" height="80%"></iframe>
  ...
  <div class="slide" id="reaktor-slide">
   ...
   <div class="slide" id="dense-slide">
               <section class="middle">
   <iframe src="./lib/plug/dense/web.php" width="94%" height="90%"></iframe>
          </section>
            <aside class="note">
            <section>
              web density
